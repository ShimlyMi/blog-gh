...
<template>
  <div class="info-bg">
    <v-img :cover="true" height="100%" :src="configDetail.avatar_bg" width="100%">
      <template #error>
  ...
  <div class="info-avatar">
    <router-link to="/">
      <v-avatar>
        <template #default>
          <img alt="头像" :src="configDetail.blog_avatar">
        </template>
      </v-avatar>
    </router-link>
...
.button-animated {
  ...
  &:before {
    ...
    //background-image: linear-gradient(to right, #b8cbb8 0%, #b8cbb8 0%, #b0c28a 0%, #aace9f 33%, #AACE9F 66%, #9FACE1F 100%);
    content: "";
