export default {
  ...
  app: {
    Tip: '温馨提示',
    logoutMessage: '确认退出登录？',
    menuLoading: '菜单加载中...',
  },
  exception: {
    backLogin: '返回登录',
    backHome: '返回主页',
    subTitle403: '您还未开启访问此页面的权限哦~',
    subTitle404: '您访问的页面离家出走了~',
    subTitle500: '服务器报错啦~',
    noDataTitle: '主人好懒，还没贡献数据',
    networkErrorTitle: '网络错误',
    networkErrorSubTitle: '您的网络连接已断开，请检查网络!',
  },
  login: {
    backSignIn: '返回',
    signInFormTitle: '登录',
